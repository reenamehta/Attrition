...
#setwd("C:/IMARTICUS Learning/PROJECT_R")
  ...
  setwd("F://DATA SCIENTIST/R_Module/Final R project")
...
##############AFTER MERGING 2 DIFFERENT CODES, to be on safer side,
#we converted all the categorical variables as factor ########
